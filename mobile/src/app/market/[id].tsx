...
export default function Market() {
    ...
    console.log(params.id) // Pegar id do estabelecimento para ler o QR de maneira correta.
    ...
    <View style={{flex: 1}}>
        ...
        <Modal style={{flex: 1}} visible={isVisibleCameraModal}>
            <CameraView style={{ flex: 1 }} facing="back" onBarcodeScanned={({data}) => {if(data && !qrLock.current){
                qrLock.current = true
